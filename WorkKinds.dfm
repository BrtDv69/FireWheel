inherited frmWorkKinds: TfrmWorkKinds
  Left = 261
  Top = 133
  Width = 523
  Height = 293
  ...
  object cxGrid: TcxGrid [1]
    ...
    object tvWorkKinds: TcxGridDBTableView
      OnKeyPress = tvWorkKindsKeyPress
      OnKeyUp = wwDBGrid4KeyUp
      DataController.DataSource = dsMainKinds
      ...
      OnFocusedRecordChanged = tvWorkKindsFocusedRecordChanged
      ...
      OnCustomDrawColumnHeader = tvWorkKindsCustomDrawColumnHeader
      object tvWorkKindsKIND_NAME: TcxGridDBColumn
      ...
      object tvWorkKindsSHORT_NAME: TcxGridDBColumn
    ...
    object glWorkKinds: TcxGridLevel
      GridView = tvWorkKinds
    end
  end
  ...
  object ibdsMainKinds: TIBDataSet
    Database = frmDM.dbMain
    Transaction = trMain
    AfterDelete = ibdsMainKindsAfterDelete
    OnNewRecord = ibdsMainKindsNewRecord
    BufferChunks = 20
    CachedUpdates = True
    DeleteSQL.Strings = (
      ...
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into WORK_KINDS'
      '  (ID, KIND_NAME, SHORT_NAME)'
      'values'
      '  (:ID, :KIND_NAME, :SHORT_NAME)')
    RefreshSQL.Strings = (
      'Select '
      ...
      '  ID = :ID')
    SelectSQL.Strings = (
      'select WK.ID, WK.KIND_NAME, WK.SHORT_NAME'
      'from WORK_KINDS WK'
      'order by 2')
    ModifySQL.Strings = (
      'update WORK_KINDS'
    ...
    Left = 10
    Top = 64
    object ibdsMainKindsID: TIntegerField
      FieldName = 'ID'
      Origin = '"WORK_KINDS"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object ibdsMainKindsKIND_NAME: TIBStringField
      FieldName = 'KIND_NAME'
      Origin = '"WORK_KINDS"."KIND_NAME"'
      Required = True
      Size = 100
    end
    object ibdsMainKindsSHORT_NAME: TIBStringField
      FieldName = 'SHORT_NAME'
      Origin = '"WORK_KINDS"."SHORT_NAME"'
    end
  end
  object dsMainKinds: TDataSource
    DataSet = ibdsMainKinds
    OnStateChange = dsMainKindsStateChange
    Left = 10
    Top = 94
  end
