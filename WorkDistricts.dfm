inherited frmWorkDistricts: TfrmWorkDistricts
  Left = 229
  Top = 141
  Width = 541
  Height = 354
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1091#1095#1072#1089#1090#1082#1086#1074' '#1088#1072#1073#1086#1090
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object cxGrid: TcxGrid [1]
    ...
    object tvWorkDistricts: TcxGridDBTableView
      OnKeyPress = tvWorkDistrictsKeyPress
      OnKeyUp = wwDBGrid4KeyUp
      DataController.DataSource = dsMainDistricts
      ...
      OnFocusedRecordChanged = tvWorkDistrictsFocusedRecordChanged
      ...
      OnCustomDrawColumnHeader = tvWorkDistrictsCustomDrawColumnHeader
      object tvWorkDistrictsDISTRICT_NAME: TcxGridDBColumn
        Caption = #1053#1072#1080#1084#1077#1085#1086#1074#1072#1085#1080#1077
        HeaderAlignmentHorz = taCenter
        HeaderAlignmentVert = vaCenter
        Options.Grouping = False
        DataBinding.FieldName = 'DISTRICT_NAME'
      end
    end
    object glWorkDistricts: TcxGridLevel
      GridView = tvWorkDistricts
    end
  end
  ...
  object ibdsMainDistricts: TIBDataSet
    Database = frmDM.dbMain
    Transaction = trMain
    AfterDelete = ibdsMainDistrictsAfterDelete
    OnNewRecord = ibdsMainDistrictsNewRecord
    BufferChunks = 500
    CachedUpdates = True
    DeleteSQL.Strings = (
      'delete from WORK_DISTRICTS'
      'where'
      '  ID = :OLD_ID')
    InsertSQL.Strings = (
      'insert into WORK_DISTRICTS'
      '  (ID, DISTRICT_NAME)'
      'values'
      '  (:ID, :DISTRICT_NAME)')
    RefreshSQL.Strings = (
    ...
    Left = 10
    Top = 64
    object ibdsMainDistrictsID: TIntegerField
      FieldName = 'ID'
      Origin = '"WORK_DISTRICTS"."ID"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object ibdsMainDistrictsDISTRICT_NAME: TIBStringField
  ...
  object dsMainDistricts: TDataSource
    DataSet = ibdsMainDistricts
    OnStateChange = dsMainDistrictsStateChange
    Left = 10
    Top = 94
  end
